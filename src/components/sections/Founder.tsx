    ...
    <section className="bg-paper px-5 py-28 sm:px-8 md:py-40">
      <div className="mx-auto max-w-7xl">
        <div className="border-b border-line pb-8">
          <h1 className="display text-3xl font-bold uppercase leading-[1.05] tracking-[-0.02em] text-ink sm:text-4xl">
            {founder.name}
          </h1>
          <p className="font-accent mt-3 text-lg text-ink sm:text-xl">Founder &amp; Curious Human</p>
        </div>
