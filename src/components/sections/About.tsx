...
export function About() {
  return (
    <section id="about" className="relative scroll-mt-24 bg-paper px-5 py-28 sm:px-8 md:py-40">
            ...
            <div className="lg:sticky lg:top-32">
              <Reveal>
                ...
                <h2 className="display mt-6 text-5xl font-bold uppercase leading-[0.95] tracking-[-0.02em] text-ember sm:text-6xl md:text-7xl">
                  Once upon a time,
                  <br />
                  <span className="text-4xl sm:text-5xl md:text-6xl">...someone asked,</span>
                  <br />
