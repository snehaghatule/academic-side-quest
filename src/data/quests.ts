...
export const founder = {
  ...
  bio: [
    ...
    "Psychology refuses to stay where you put it. It is less a collection of settled facts than a set of complex, evolving models for understanding why people feel, relate, and suffer the way they do. And the best way to learn it, I've found, is by wrestling with those ideas out loud.",
